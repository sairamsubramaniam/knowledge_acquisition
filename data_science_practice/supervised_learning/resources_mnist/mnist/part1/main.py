...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    print("MOD3 TEST error; ", compute_test_error_mod3(test_x, test_y, theta, temp_parameter))
    return test_error
...
# print("Error Training with Mod 3 =: ", run_softmax_on_MNIST_mod3(temp_parameter=1))
...
print('PCA softmax test_error=', test_error)
